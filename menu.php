...
<TR><TD align=left>
  ...
  <TABLE border="0" cellpadding="0" cellspacing="0">
   <TR>
    <TD><IMG SRC="images/button-left.gif" width="10" height="33"></TD>
    <TD background="images/button-middle.gif"><A HREF="brzones.php" target="canvas"><B>Browse zones</B></A></TD>
    <TD><IMG SRC="images/button-join.gif" width="30" height="33"></TD>
    <TD background="images/button-middle.gif"><A HREF="brrec.php" target="canvas"><B>Browse records</B></A></TD>
    <TD><IMG SRC="images/button-join.gif" width="30" height="33"></TD>
    <TD background="images/button-middle.gif"><A HREF="addzone.php" target="canvas"><B>Add a zone</B></A></TD>
    <TD><IMG SRC="images/button-join.gif" width="30" height="33"></TD>
    <TD background="images/button-middle.gif"><A HREF="delzone.php" target="canvas"><B>Delete a zone</B></A></TD>
    <TD><IMG SRC="images/button-join.gif" width="30" height="33"></TD>
...
<TD ALIGN=CENTER><B>Version<BR>2.2.1</B></font></TD>
